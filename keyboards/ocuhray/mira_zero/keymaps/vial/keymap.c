...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3(
        ...
        LGUI_T(KC_EQL),   LALT_T(KC_Z), KC_X,    KC_C,    KC_V,    KC_B,               LT(2, KC_N),    KC_M,    KC_COMM, KC_DOT,  RALT_T(KC_SLSH), RGUI_T(KC_GRV),
        LCTL_T(KC_LNG2), LT(1, KC_SPC), LSFT_T(KC_BSPC),                              LSFT_T(KC_TAB), LT(1, KC_ENT),  LCTL_T(KC_LNG1)
    ),

    [1] = LAYOUT_split_3x6_3(
        KC_PIPE,         KC_EXLM,       KC_AT,   KC_HASH, KC_DLR,  KC_PERC,            KC_CIRC,        KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,        KC_RCBR,
        KC_BSLS,         KC_1,          KC_2,    KC_3,    KC_4,    KC_5,               KC_6,           KC_7,    KC_8,    KC_9,    KC_0,           KC_RBRC,
